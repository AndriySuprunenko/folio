...
import arrow from '../../assets/svg/Style 1.svg';
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.content_text}>
            <div className={styles.content_text_title}>
              <span className={styles.content_text_span}>05</span>We are hiring
            </div>
            <div className={styles.content_text_subtitle}>Jobs</div>
            <div className={styles.content_text_text}>
              Agency is a full-service agency, busy designing and building
              beautiful digital products, brands, and experiences.
            </div>
            <div className={styles.content_text_link}>
              <a href="#sec-1">
                <img
                  className={styles.content_text_link_arrow}
                  src={arrow}
                  alt="arrow"
                />
              </a>
        ...
        <div className={styles.content_card}>
          ...
          <div className={styles.card}>
            <div className={styles.card_title}>Graphic Designer</div>
            <div className={styles.card_text}>2 years experience</div>
            <button className={styles.button}>&rarr;</button>
          </div>

          {/* Card */}
          <div className={styles.card}>
            <div className={styles.card_title}>Visual Designer</div>
            <div className={styles.card_text}>2 years experience</div>
            <button className={styles.button}>&rarr;</button>
          </div>
          ...
          {/* Card */}
          <div className={styles.card}>
            <div className={styles.card_title}>Art Director</div>
            <div className={styles.card_text}>2 years experience</div>
            <button className={styles.button}>&rarr;</button>
          </div>
          ...
          {/* Card */}
          <div className={styles.card}>
            <div className={styles.card_title}>Web Designer</div>
            <div className={styles.card_text}>2 years experience</div>
            <button className={styles.button}>&rarr;</button>
          </div>
        </div>
