...
import arrowDown from '../../assets/svg/Style 1.svg';
import bgBunner from '../../assets/png/banner-bg.png';
import Grid from '../../assets/png/Grid.png';
import Desktop from '../../assets/png/Desktop3.png';
import HeadL from '../../assets/png/Hand-l.png';
import HeadR from '../../assets/png/Hand-r.png';
    ...
    <section className={styles.banner}>
      <div className={styles.container}>
        <div className={styles.text}>
          <h1 className={styles.text__title}>Stand Out from The Crowd.</h1>
          ...
          <div className={styles.text__button1}>
            <Button text="Recent Work" classes={ButtonTypes.BLUE}></Button>
          </div>
          <div className={styles.text__button2}>
            <Arrow src={arrowDown}></Arrow>
          </div>
        </div>
        ...
        <div className={styles.image}>
          <img className={styles.image__bg} src={bgBunner} alt="banner" />
          <img className={styles.image__grid} src={Grid} alt="grid" />
          <img className={styles.image__desktop} src={Desktop} alt="Desktop" />
          <img className={styles.image__head__l} src={HeadL} alt="head" />
          <img className={styles.image__head__r} src={HeadR} alt="head" />
        </div>
      </div>
    </section>
  );
